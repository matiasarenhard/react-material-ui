    ...
    <Box sx={{ display: 'flex' }} className={styles.sidenav}>
      ...
      <Drawer variant="permanent" open={open} classes={{ paper: styles.sidenav }}>
        <DrawerHeader classes={{ paper: styles.sidenav }}>
          <IconButton size="large" aria-label="show 4 new mails" color="inherit" align="left">
          ...
          <IconButton onClick={handleDrawerClose} classes={{ paper: styles.sidenav }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }} className={styles.body}>
        <DrawerHeader />
